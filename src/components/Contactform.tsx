...
// Define CSS styles for input fields and radio buttons
const inputStyle =
...
const ContactForm = () => {
  ...
  return (
    <div className="bg-plum p-8 font-cursive drop-shadow-lg max-w-screen-sm max-h-80">
      <form
        action="/contacts"
        onSubmit={handleSubmit}
        className="flex flex-col space-y-4"
      >
        <h2 className="self-center text-4xl font-cursive text-white">
          Create Contact
        </h2>
        <div>
          <label 
