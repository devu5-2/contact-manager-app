...
const buttonStyle = "bg-black hover:bg-periwinkle hover:text-black p-2 text-white";
const linkStyle = "w-fit";

const Navbar = () => {
  return (
    <nav className="bg-brown p-4 flex font-cursive basis-1/5 gap-2 flex-row md:flex-col">
